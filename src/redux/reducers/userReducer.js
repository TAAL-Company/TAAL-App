...
const userReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case types.ENTER_APP:
      // const condition = action.payload !== (state.lastFetch.date || "")
      return {
        ...state,
        user: {
          ...state.user,
